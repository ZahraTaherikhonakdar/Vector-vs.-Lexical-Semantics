...
from src.eval import evaluation,pytrec_eval_per_word,evaluation_tf_idf,pytrec_eval_perword_tfidf,pytrec_avg
...
def eval():
    ...
    print("pytrec_avg...")
    pytrec_avg.pytrec_avg_w2v(wordsList,"brown_news")
    pytrec_avg.pytrec_avg_w2v(wordsList, "brown_editorial")
...
def pytrec_tfidf():
    ...
    pytrec_avg.pytrec_avg_tfidf(wordsList,"brown_editorial")
    pytrec_avg.pytrec_avg_tfidf(wordsList, "brown_news")
